					...
					<div>
						<div class="row">
							<div class="col-md">
								...
								Proses skripsi menjadi lebih teratur dan cepat yang dilakukan secara online yang bisa diakses dimana saja
								melalui browser dengan bertujuan menghemat waktu, tenaga dan memudahkan mendapatkan informasi proses skripsi
								secara Online.
							</div>
							<div class="col-md-5">
								<form id="form-login" method="POST" action="<?=base_url('Home/session');?>">
									...
									<div class="text-center">
										<button type="submit" class="btn btn-primary float-right ml-3" id="btn-login"> <i class="fas fa-sign-in-alt"></i>
											Login</button>
									</div>
									<small class="form-text text-muted"> Login Username Dan Password Diberikan Melalui Email Setiap Mahasiswa Yang
										Terdaftar </small>
								</form>
							</div>
						</div>
		...
		<div class="row m-1" id="informasi">
			<div class="col-md-6">
				<div class="form-row">
					...
					<div class="form-group col small">
						...
						Data skripsi mahasiswa akan tersimpan di dalam sistem yang memudahkan kepala program pendidikan atau admin dalam
						mencari data skripsi lama yang mungkin dibutuhkan untuk refrensi saat mahasiswa tingkat selanjutnya membutuhkan
						refrensi skripsi atau sekedar membandingkan dengan skripsi sebelumnya
					</div>
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-row">
					...
					<div class="form-group col small">
						...
						Kartu bimbingan merupakan hal wajib bagi setiap mahasiswa untuk melakukan bimbingan dengan dosen pembimbing, oleh
						karena itu kartu bimbingan dibuat online dimana dosen pembimbing bisa memberi catatan pada mahasiswa yang bisa
						dicetak saat dibutuhkan, yang dilengkapi dengan fitur QR_Code bisa dipastikan keaslian kartu bimbingan dan dosen
						maupun kaprodi bisa melihat perkembangan skripsi mahasiswa.
					</div>
				</div>
			...
			<div class="col-md-6">
				<div class="form-row">
					...
					<div class="form-group col small">
						...
						Pengajuan judul mahasiswa merupakan proses yang membutuhkan banyak waktu dan tenaga dimana mahasiswa harus datang
						ke kampus untuk melakukan pengajuan judul skripsi yang ingin diajukan dimana belum tentu skripsi tersebut akan
						disetujui oleh kaprodi, pengajuan secara online menghemat waktu dan tenaga mahasiswa dimana mahasiswa juga akan
						mendapatkan informasi diterima tidaknya judul yang diajukan
					</div>
				</div>
			...
			<div class="col-md-6">
				<div class="form-row">
					...
					<div class="form-group col small">
						<h6> Pemberitahuan </h6>
						Terkadang kaprodi kesulitan memberikan informasi kepada mahasiswa maupun dosen pembimbing terkait jadwal seminar
						/ sidang, pengajuan judul yang diterima dikarenakan banyaknya mahasiswa maupun dosen yang harus dihubungi belum
						lagi jika kaprodi tidak memiliki nomer yang bisa dihubungi, dengan memanfaatkan fitur ini mahasiswa akan
						mendapatkan pemberitahuan tentang jadwal maupun ide skripsi yang diajukan.
					</div>
				</div>
			</div>
		</div>
