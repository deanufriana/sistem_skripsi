...
<body>
	<div class="container-fluid">
		<div>
			<div>
				<div class="nav nav-pills mb-3 nav-justified" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					<a href="#" class="btn-menu nav-link"><i class="fas fa-bars"></i></a>
					<a class="nav-item nav-link active" id="v-pills-home-tab" data-toggle="tab" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true"><i class="fas fa-envelope"></i> Pemberitahuan </a>
					<?php foreach ($mahasiswa as $m) {
						?>
						<a  <?php if ($m->id_skripsi_mhs != '0') {
							echo "style='display: none;'";
						} ?> class="nav-item nav-link" id="v-pills-profile-tab" data-toggle="tab" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false"> <i class="fas fa-file-alt"></i> Ide Skripsi</a>
						<a  <?php if ($m->id_skripsi_mhs === '0') {
							echo "style='display: none;'";
					...
					<div class="row">
						<div class="col-md-3" id="mhs_profil">
										...
										<div class="card-body">
											<div class="row">
												<div <?php if ($this->session->userdata('id_skripsi_mhs') != '0') {
													echo "style='display: none;'";
												} ?> class="col-md-6" id="form_ide">
											</div>
											<div id="data_skripsi" class="col-md" style="overflow: scroll">
											</div>
										</div>
									</div>
								</div>
