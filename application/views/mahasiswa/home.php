			...
			<div>
				<div class="nav nav-pills mb-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					...
					<?php foreach ($mahasiswa as $m) {	?>
						...
						} ?> class="nav-item nav-link" id="v-pills-profile-tab" data-toggle="tab" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false"> <i class="fas fa-file-alt fa-sm"></i> Ide Skripsi 
					</a>
					<a  <?php if ($m->id_skripsi_mhs === '0') {
						echo "style='display: none;'";
