            ...
            columns: {
                ...
                toolbar: function() {
                    if (settings.editButton || settings.deleteButton) {
                        ...
                        // Create edit button.
                        if (settings.editButton) {
                            editButton = '<button type="button" class="btn btn-default ' + settings.buttons.edit.class + '" style="float: none;">' + settings.buttons.edit.html + '</button>';
                        }
                        ...
                        $table.find('tr:gt(0)').append('<td style="white-space: nowrap; width: 1%;">' + Edit + '</td>');
                    }
                }
            }
        };
